...
ax.axhline(0.0, alpha = 0.1, c='k', lw=2)
...
SPS_models = ['BPASSv2.2.1.binary/ModSalpeter_100','BPASSv2.2.binary/ModSalpeter_100','BPASSv2.1.binary/ModSalpeter_100','P2/ModSalpeter_100']
line_styles = ['-','-.',':','--']
...
SPS_labels['BPASSv2.2.binary/ModSalpeter_300'] = r'$\rm BPASSv2.2\ Modified\ Salpeter\ IMF\ m_{up}=300\ M_{\odot}$'
SPS_labels['BPASSv2.2.binary/ModSalpeter_100'] = r'$\rm BPASSv2.2\ Modified\ Salpeter\ IMF\ m_{up}=100\ M_{\odot}$'
...
fig.savefig('figures/LyC_SPS_rel.pdf')