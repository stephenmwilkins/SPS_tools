...
for i, mu in enumerate(mus):
    ...
    for tau_V_hat in tau_V_hats:
        ...
        grid.generate_UVCS()
        UVCS.append(grid.UVCS)
        A1500.append(grid.A1500())

        # print tau_V_hat, grid.A1500(), grid.EW()

    ax.plot(A1500, UVCS, c = c, label = r'$\rm\mu='+str(mu)+'$', alpha = 0.8, lw =1.0)
...
ax.plot(A1500, UVCS, c = 'k', label = r'$\rm Calzetti\ et\ al.\ (2000)$', alpha = 0.4, lw =1.5)
...
# b = (A - 4.43)/2.
# 
# ax.plot(A, b, c = 'k', label = r'$\rm Meurer\ et\ al.\ (1999)$', alpha = 0.4, lw =1.5)
# 
...
fig_name = 'figures/UVCS_dust.pdf'
